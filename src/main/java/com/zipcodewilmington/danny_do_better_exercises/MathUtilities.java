...
public class MathUtilities {
    ...
    public Integer subtract(int baseValue, int difference) {
        Integer subtract = baseValue - difference;
        return subtract;
    }
    ...
    public Integer divide(int dividend, int divisor) {
        Integer divide = dividend / divisor;
        return divide;
    }
